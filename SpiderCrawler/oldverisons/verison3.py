...
#old method for use with the other old method delte if issue
...
def fetch_and_display_cve_details(cve_id):
    ...
    if cve_details:
        ...
        #root.after(100, lambda: display_exploit_details(cve_details, cve_id))
        #root.after(120, lambda: search_githubandgoogle_for_exploits(cve_id))
        #time.sleep(1)
